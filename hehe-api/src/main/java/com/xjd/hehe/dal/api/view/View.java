package com.xjd.hehe.dal.api.view;
...
public class View {
	...
	public String toString() {
		return "View [returnCode=" + returnCode + ", returnMsg=" + returnMsg + ", service=" + service + ", version=" + version
				+ ", timestamp=" + timestamp + ", originalCode=" + originalCode + ", originalMsg=" + originalMsg + ", body="
				+ body + "]";
	}
