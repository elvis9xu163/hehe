...
@Service
public class SpiderJokeText {
	private static Logger log = LoggerFactory.getLogger(SpiderJokeText.class);
	...
	public void grap() {
		...
		try {
			...
			while (true) {
				...
				log.info("text grab: {}-{}", page, content);
