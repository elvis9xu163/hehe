...
@Service
public class SpiderJokeTopicBeauty {
	private static Logger log = LoggerFactory.getLogger(SpiderJokeTopicBeauty.class);
	...
	public void grap() {
		...
		try {
			...
			while (true) {
				...
				log.info("topic_beauty grab: {}-{}", page, content);
			...
			log.error("抓取topic_beauty joke异常.", e);
