...
@Service
public class SpiderJokeWebGood {
	private static Logger log = LoggerFactory.getLogger(SpiderJokeWebGood.class);
	...
	public void grap() {
		...
		try {
			...
			while (true) {
				...
				log.info("web_good grab: {}-{}", page, content);
