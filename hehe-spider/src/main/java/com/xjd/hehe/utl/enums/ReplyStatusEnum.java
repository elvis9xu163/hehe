...
public enum ReplyStatusEnum {
	...
	ReplyStatusEnum(int code, String desc) {
		this.code = code;
		this.desc = desc;
	}
	...
	public String toString() {
		return ReplyStatusEnum.class.getSimpleName() + "[code=" + code + ", desc=" + desc + "]";
	}

	public static ReplyStatusEnum valueOfCode(Integer code) {
		if (code == null) {
			return null;
		}
