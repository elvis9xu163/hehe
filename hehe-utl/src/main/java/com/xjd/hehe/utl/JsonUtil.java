...
public abstract class JsonUtil {
	...
	static {
		...
		objectMapperWithDateFormat.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
		objectMapperIncludeIgnoredProperties.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
